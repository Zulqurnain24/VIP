...
class TrackDetailViewController: BaseViewController {
    ...
    internal let shareView: ShareView = ShareView()
    internal let artworkImageView: UIImageView = UIImageView()
    internal let trackNameLabel: UILabel = UILabel()
    internal let artistNameLabel: UILabel = UILabel()
    internal let trackDuration: PlayerTrackDuration = PlayerTrackDuration()
    internal let playerControls: PlayerControls = PlayerControls()
