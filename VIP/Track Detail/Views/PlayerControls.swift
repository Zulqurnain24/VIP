...
class PlayerControls: UIView {
    ...
    internal let playButton: UIButton = UIButton(type: .custom)
    internal let prevButton: UIButton = UIButton(type: .custom)
    internal let nextButton: UIButton = UIButton(type: .custom)
