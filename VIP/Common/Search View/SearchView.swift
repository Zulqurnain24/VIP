...
class SearchView: UIView {
    ...
    internal let searchContainerView: UIView = UIView()
    internal var searchContainerViewTrailingConstraint: NSLayoutConstraint?

    internal let searchBar: UISearchBar = UISearchBar()

    internal let cancelButton: UIButton = UIButton(type: .custom)
    internal var cancelButtonWidthConstraint: NSLayoutConstraint?
...
extension SearchView {
    ...
    private func addSubviews() {
        ...
        let searchContainerViewTrailingConstraint = NSLayoutConstraint(item: searchContainerView, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing,
        multiplier: 1.0, constant: Layout.SearchContainerView.trailing)
