//
//  TrackCollectionViewRowCell.swift
//  VIP
//
...
class TrackCollectionViewRowCell: UICollectionViewCell {

    internal let trackImageView: UIImageView = UIImageView()
    internal let artistNameLabel: UILabel = UILabel()
    internal let collectionNameLabel: UILabel = UILabel()
    internal let trackNameLabel: UILabel = UILabel()
    internal let releaseDateLabel: UILabel = UILabel()
    internal let trackInformationLabel: UILabel = UILabel()
    internal let genreLabel: UILabel = UILabel()
...
extension TrackCollectionViewRowCell {
...
extension TrackCollectionViewRowCell {
    ...
    private func configureSubviews() {
        ...
        trackImageView.frame = CGRect(x: 0.0, y: 0.0, width: 75.0, height: 75.0)
    ...
    private func addSubviews() {
        ...
        addConstraintsWithFormat("H:|[v0(\(Layout.TrackImageView.width))]-\(5)-[v1]|", views: trackImageView, artistNameLabel)
        addConstraintsWithFormat("V:|[v0(\(Layout.TrackImageView.width))]|", views: trackImageView)

        addConstraintsWithFormat("H:|[v0]-\(5)-[v1]|", views: trackImageView, artistNameLabel)
        ...
        addConstraintsWithFormat("H:|[v0]-\(5)-[v1]|", views: trackImageView, collectionNameLabel)
        ...
        addConstraintsWithFormat("H:|[v0]-\(5)-[v1]|", views: trackImageView, trackNameLabel)
        ...
        addConstraintsWithFormat("H:|[v0]-[v1(\(Layout.ReleaseDateLabel.width))]-\(Layout.ReleaseDateLabel.trailing)-[v2]|", views: trackImageView, releaseDateLabel, genreLabel)
        ...
        addConstraintsWithFormat("H:|[v0]-\(5)-[v1]|", views: trackImageView, trackInformationLabel)
